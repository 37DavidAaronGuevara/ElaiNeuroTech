...
def Abrir_FisicaBasica():
    ...
    def Peso_Planeta():
        ...
        etiqueta_luna = Label(marco, font="Times 15",text="Luna: ",bg=colores[4], fg="white")
        entrada_luna = Entry(marco, font="Times 15",state="readonly")
        etiqueta_mercurio = Label(marco, font="Times 15",text="Mercurio: ",bg=colores[4], fg="white")
        entrada_mercurio = Entry(marco, font="Times 15",state="readonly")
        venus_label = Label(marco, font="Times 15",text="Venus: ",bg=colores[4], fg="white")
        entrada_venus = Entry(marco, font="Times 15",state="readonly")
        etiqueta_marte = Label(marco, font="Times 15",text="Marte: ",bg=colores[4], fg="white")
        entrada_marte = Entry(marco, font="Times 15",state="readonly")
        etiqueta_jupiter = Label(marco, font="Times 15",text="Jupiter: ",bg=colores[4], fg="white")
        entrada_jupiter = Entry(marco, font="Times 15",state="readonly")
        etiqueta_saturno = Label(marco, font="Times 15",text="Saturno: ",bg=colores[4], fg="white")
        entrada_saturno = Entry(marco, font="Times 15",state="readonly")
        etiqueta_neptuno = Label(marco, font="Times 15",text="Neptuno: ",bg=colores[4], fg="white")
        entrada_neptuno = Entry(marco, font="Times 15",state="readonly")
        etiqueta_urano = Label(marco, font="Times 15",text="Urano: ",bg=colores[4], fg="white")
        entrada_urano = Entry(marco, font="Times 15",state="readonly")
        etiqueta_pluton = Label(marco, font="Times 15",text="Pluton: ",bg=colores[4], fg="white")
